...
public class ANCActivity2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ancactivity2);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.clear();
                editor.apply();
                startActivity(new Intent(ANCActivity2.this,DecisionActivity.class));
            }
        });
        ...
        ANC1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ANCActivity2.this,HomeActivity2.class));
        ...
        Health.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ANCActivity2.this,HealthArticlesActivity.class));
            }
        });
    }
}